...
//Usuarios
export const registerRequest = (user) => client.post("/register", user);
...
export const getServiceProducts = (config) =>
  client.get("/service-products/readall", config);
export const updateServiceProduct = (id, changes) =>
  client.put(`/user/service-product/update/${id}`, changes);
export const deleteServiceProduct = (id) =>
  client.delete(`/user/service-product/delete/${id}`);
...
//eventos
export const getEvents = (config) => client.get("/events/readall", config);
export const createEvent = (event) => client.post(`/user/event/create`, event);
export const updateEvent = (id, changes) =>
  client.put(`/user/event/update/${id}`, changes);
export const deleteEvent = (id) =>
  client.delete(`/user/event/delete/${id}`);
