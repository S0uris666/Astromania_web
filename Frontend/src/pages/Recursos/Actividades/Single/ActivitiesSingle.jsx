...
import { ServiceProductGallery } from "../../../ServiceProduct/Single/components/Gallery";
import { BreadcrumbsTrail } from "../../../ServiceProduct/Single/components/BreadcrumbsTrail";
import { InfoBadges } from "../../../ServiceProduct/Single/components/InfoBadges";
import { ActionButtons } from "../../../ServiceProduct/Single/components/ActionButtons";
import { LinksList } from "../../../ServiceProduct/Single/components/LinksList";
import { TagList } from "../../../ServiceProduct/Single/components/TagList";
import { MetadataGrid } from "../../../ServiceProduct/Single/components/MetadataGrid";
import {
  TYPE_LABEL,
  buildBreadcrumbs,
  formatPrice,
...
export const ActivitiesSingle = () => {
  ...
  if (!item) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-16 text-center space-y-4">
        <p className="opacity-70">No encontramos esta actividad.</p>
        <Link to="/recursos/actividades" className="btn btn-primary">
  ...
  if (String(item.type || "").toLowerCase() !== "activity") {
    return (
      <div className="max-w-3xl mx-auto px-4 py-16 text-center space-y-4">
        <p className="opacity-70">Esta actividad no est� disponible.</p>
        <Link to="/recursos/actividades" className="btn btn-primary">
          Volver a actividades
        </Link>
      </div>
  ...
  const priceLabel = isActivity ? null : formatPrice(item.price);
