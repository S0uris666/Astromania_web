...
const ProfileSummaryCard = ({ user, isPublished }) => {
  ...
  return (
    <div className="card bg-base-100 shadow-2xl border border-base-200 lg:card-side">
      <figure className="bg-gradient-to-br from-base-200 via-base-300/60 to-base-200 flex items-center justify-center lg:w-72 xl:w-80 lg:h-full p-6">
        {imageUrl ? (
          <div className="avatar">
            <div className="mask mask-squircle bg-base-100 shadow-inner border border-base-200 w-48 h-48 flex items-center justify-center">
              <img
                src={imageUrl}
          ...
          <div className="avatar placeholder">
            <div className="mask mask-squircle bg-base-300 text-base-content/60 w-48 h-48 flex items-center justify-center">
              <span className="text-xs uppercase tracking-wide">Sin imagen</span>
            </div>
          </div>
        )}
      </figure>

      <div className="card-body space-y-4 lg:flex-1">
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <span
            className={`badge badge-lg ${isPublished ? "badge-success" : "badge-warning"} uppercase tracking-wide`}
          >
        ...
        {specializationList.length ? (
          <div className="card-actions justify-start flex-wrap gap-2">
            {specializationList.map((item, index) => (
              <span key={`${item}-${index}`} className="badge badge-outline badge-lg">
                {item}
              </span>
            ))}
          </div>
        ...
        <div className="card-body space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div>
              ...
              <p className="text-base text-base-content/70 mt-2">
                Administra tu presencia publica y manten al dia tu perfil de divulgador.
              </p>
            </div>
          ...
          {!isPublished && (
            <div className="alert alert-warning">
              <span>
                Tu perfil esta oculto. Activa la opcion &quot;Visible para la comunidad&quot; en la
                edicion para aparecer en Comunidad &gt; Divulgadores.
              </span>
            </div>
          )}
        </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="card bg-base-200 shadow-md hover:shadow-lg transition-shadow">
          <div className="card-body">
            ...
            <p className="text-sm text-base-content/70">
              Programa actividades con fecha, lugar, aforo e inscripcion.
            </p>
        ...
        <div className="card bg-base-200 shadow-md hover:shadow-lg transition-shadow">
          <div className="card-body space-y-3">
            ...
            <p className="text-sm text-base-content/70">
              Ajusta tus preferencias o cierra sesion cuando lo necesites.
            </p>
        ...
        <div className="lg:col-span-2">
          <div className="card bg-base-200 shadow-sm">
            <div className="card-body">
              ...
              {!cart.length ? (
                <p className="opacity-70">Tu carrito esta vacio por ahora.</p>
              ) : (
                <>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between mt-4">
                    ...
                    <div className="w-full sm:w-80">
                      <PaymentButton
                        ...
                        onRequireLogin={() => navigate("/login?next=/perfil_divulgador")}
                      />
                      {!authState && (
